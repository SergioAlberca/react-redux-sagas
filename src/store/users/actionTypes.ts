...
export const FETCH_DETAIL_USER_REQUEST = 'FETCH_DETAIL_USER_REQUEST'
export const FETCH_DETAIL_USER_SUCCESS = 'FETCH_DETAIL_USER_SUCCESS'
export const FETCH_DETAIL_USER_FAILURE = 'FETCH_DETAIL_USER_FAILURE'
...
export const FETCH_RESET_USER_STORE = 'FETCH_RESET_USER_STORE'
export const FETCH_RESET_USER_SUCCESS = 'FETCH_RESET_USER_SUCCESS'
export const FETCH_RESET_USER_FAILURE = 'FETCH_RESET_USER_FAILURE'
